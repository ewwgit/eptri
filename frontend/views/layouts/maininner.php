...
<header>
	...
	<div id="header_part">
		...
		<!--  *** sell ***  --> 
		<div class="container">
			<div class="sell"><a href="<?= Url::to(['/vendor/vendor'])?>"><img src="<?php echo $url ?>/images/shop.png" class="img-responsive"/><p>sell</p></a></div>
		</div>
		<!--  *** header_top ***  --> 
		<div class="header_top">
			<div class="container">
				<div class="row">
					<!--  *** col-sm-4 ***  --> 
					<div class="col-sm-4">
						<div class="logo"><a href="<?= $url ?>"><img src="<?php echo $url ?>/images/logo.png" alt="" title="grocery Deals" ></a></div>
					</div>
					<!--  *** col-sm-4 ***  --> 
					<div class="col-sm-4">
						<div class="search">
	    ...
	    <div class="row">
			...
			<div class="col-sm-9">
			    ...
			    <div class="footer_menus">
					<ul>
						...
						<li><a href="#" title="GB Dictionary ">GB Dictionary </a></li>
			    ...
			    <div class="footer_menus">
					<ul>
						<li><a href="#" title="Legal Info">Legal Info </a></li>
						<li><a href="#" title="Terms of use"> Terms of use</a></li>
						<li><a href="#" title="Privacy ">Privacy </a></li>
						<li><a href="#" title="Infringement">Infringement</a></li>
					</ul>
				</div>
				<div class="follow">
				     <p>Follow Us:</p>
			...
			<div class="col-sm-3">
				<div class="adress">
					...
					<p>Work with Indian or Asian Grocery Store to Grow your business <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i> </p>
				</div>
			</div>
			 <!-- *** col-sm-3 ***-->
			 <div class="col-sm-3">
			    <div class="adress">
					<span  class="mobile"><i class="fa fa-mobile" style="color:#7dab4e;"></i></span>
					<p>Get grocer deals Mobile App<br>
